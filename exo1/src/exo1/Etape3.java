...
public class Etape3 implements Etape {
	...
	public void test() {
		...
		//appeler la méthode static forEach 2 fois avec la liste. 
		// La 1ère invocation utilisera une référence à la méthode String::format.
		forEach(prenoms, String::format);
		//La 2ème invocation utilisera une lambda expression équivalente dont le corps invoque la méthode format.
		
		forEach(prenoms, (f,s)->String.format(f,s));
